...
#ifdef ESP32
//#include <AsyncTCP.h>
#include "../../AsyncTCP/src/AsyncTCP.h"              //MODIFIED FROM ORIGINAL LIBRARY
...
#include "ESPAsyncWebSrv.h"  //MODIFIED FROM ORIGINAL LIBRARY

//#include "AsyncWebSynchronization.h"
#include "AsyncWebSynchronization.h"  //MODIFIED FROM ORIGINAL LIBRARY
